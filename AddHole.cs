...
namespace RevitAPITrainig8
{
    ...
    public class AddHole : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            transaction.Start("Расстановка отверстий для воздуховодов в стенах");
            ...
            foreach (Duct d in ducts)
            {
                ...
                foreach (ReferenceWithContext refer in intersections)
                {
                    ...
                    Parameter widht = hole.LookupParameter("Ширина");
                    Parameter height = hole.LookupParameter("Высота");
                    widht.Set(d.Diameter);
            ...
            transaction1.Start("Расстановка отверстий для труб в стенах");
            ...
            //transaction2.Start("Расстановка отверстий для труб в перекрытие");
            ...
            //        Level level = arDoc.GetElement(floor.LevelId) as Level;
            //        XYZ pointHole = point + (direction * proximity);
            //        FamilyInstance hole = arDoc.Create.NewFamilyInstance(pointHole, familySymbol, floor, level, StructuralType.NonStructural);
            //        Parameter width = hole.LookupParameter("Ширина");
            //        Parameter height = hole.LookupParameter("Высота");
            //        width.Set(p.Diameter);
            //        height.Set(p.Diameter);
